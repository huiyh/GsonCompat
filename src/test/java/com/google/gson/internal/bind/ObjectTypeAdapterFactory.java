...
public final class ObjectTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public ObjectTypeAdapterFactory() {
        this(new ConstructorConstructor(Collections.emptyMap()));
    }

    public ObjectTypeAdapterFactory(ConstructorConstructor constructorConstructor) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, final TypeToken<T> typeToken) {
        ...
        if (Collection.class.isAssignableFrom(rawType)) {
            ...
            ObjectConstructor<T> constructor = constructorConstructor.get(typeToken);
            return new ReflectivtTypeAdapter<T>(constructor, getBoundFields(gson, typeToken, rawType));
        }
    }
    ...
    public static final class ReflectivtTypeAdapter<T> extends TypeAdapter<T> {
        private final ObjectConstructor<T> constructor;
        private final Map<String, BoundField> boundFields;

        ReflectivtTypeAdapter(ObjectConstructor<T> constructor, Map<String, BoundField> boundFields) {
            this.constructor = constructor;
